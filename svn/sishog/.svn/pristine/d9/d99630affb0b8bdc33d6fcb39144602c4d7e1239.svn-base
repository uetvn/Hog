...
set ADDITIONAL_SEARCH_PATH        "${PROJECT_DIR}/syn/inputs
                                   ${DESIGN_KIT_PATH}/Front_End/db/NLDM"  ;#  Additional search path to be added to the default search path

set TARGET_LIBRARY_FILES          "NangateOpenCellLibrary_typical.db"  ;#  Target technology logical libraries
set ADDITIONAL_LINK_LIB_FILES     "NangateOpenCellLibrary_slow.db NangateOpenCellLibrary_fast.db"  ;#  Extra link logical libraries not included in TARGET_LIBRARY_FILES
